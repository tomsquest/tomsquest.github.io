...
lang: fr
image: /assets/images/posts/2008-10-29-selenium-boostez-vos-tests-avec-tellurium/tellurium.png
---
...
Puis, vous avez commencé à [écrire vos tests en Java (cf mon article)](/blog/2008/09/selenium-en-java-demarrage-rapide/) et la vie fut plus belle. Mais cela devint verbeux et vous développiez de plus en plus de code custom pour améliorer vos tests. Et vous vous demandiez comment faire encore mieux...
